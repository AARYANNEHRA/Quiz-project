...
struct students takeQuiz(struct students student[], int i)
{
    ...
    do{
        ...
        t1rand[bestOf]=(int*)calloc(5,sizeof(int));
                ...
                case 2:
                {
                    ...
                    while(j<5)
                    {
                        ...
                        do {
                            ...
                            printf("\nYour Answer : ");
                            scanf("%s",(inpt2[bestOf]+j));
                            if(strcmpi((inpt2[bestOf]+j),topic2.answer[rd]) == 0)
                            {
                                printf("Correct Answer!");
                                ansFlag = 1;
                            } else {
                            ...
                            if(ansFlag==1)
                            {
                                *t2mks[bestOf]+=2;
                                ...
                                t2atp++;
                                printf("\nRe-do Attempt/s left: %d",2-t2atp);
                ...
                case 2: {
                    ...
                    for(i = 0; i < 5;i++)
                    {
                        ...
                        if(strcmpi((inpt2[inpIndex]+i),topic2.answer[rd]) != 0) {
                            printf("\nQ. %s",topic2.question[rd]);
                            printf("\nYour Answer : %s",(inpt2[inpIndex]+i));
